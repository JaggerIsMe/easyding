 ...
 * 任务执行结果通知表参数
 */
public class JobRunResultNotificationInfoQuery extends BaseParam {
	...
	private String failDescriptionFuzzy;
	...
	public void setFailDescriptionFuzzy(String failDescriptionFuzzy){
		this.failDescriptionFuzzy = failDescriptionFuzzy;
	}

	public String getFailDescriptionFuzzy(){
		return this.failDescriptionFuzzy;
	}
